...
If I put on my [objectivist](http://en.wikipedia.org/wiki/Objectivity_(philosophy)#Objectivism) hat, I'd say that because there is an objective external reality, every story is either demonstrably true (when it agrees with reality) or demonstrably false (when it disagrees).

Alternatively, if I put on my [constructivist](http://en.wikipedia.org/wiki/Constructivist_epistemology) hat, I'd scoff at the notion of an objective external reality. Instead, I'd tell you that the answer is always "yes," because the story I tell myself *is*my reality; it is *constitutive*of reality as I experience it.

Finally, if I donned my [phenomenologist](http://en.wikipedia.org/wiki/Phenomenology_(philosophy)) hat, I'd tell you that in the strictest sense of the word "[true](http://en.wiktionary.org/wiki/veridical)," we can't answer the question. All we can do is tell the story – hopefully with as much detail as we can muster.
