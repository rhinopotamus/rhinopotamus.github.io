...
* Cut up the poblano chiles into two or three pieces each, such that each piece is pretty flat. Trim off the ribs and the thing that holds all the seeds. (The white stuff on the ribs and the seed-holder-thing is analogous to the placenta, and it's where the capsaicin glands are. [Swoosh!](https://media.giphy.com/media/R6bDgXEXCLcIw/giphy.gif))
