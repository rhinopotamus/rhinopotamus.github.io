...
{% assign filenames = "sbagleysd/starter-ready.jpg,sbagleysd/starter-floats.jpg" | split: "," %}
...
Here's my go-to [sourdough sandwich loaf]({% post_url 2020-03-04-sourdough-sandwich-loaf %}) baked in a bread pan.

One of my favorite things to make with my starter is [sourdough pizza dough]({% post_url 2020-03-04-sourdough-pizza-dough %}). The sourdough flavor is great under pizza toppings, and it just gets sourer and nicer to handle the longer it ferments in your fridge.
...
Finally, here's my grandfather's [sourdough pancakes]({% post_url 2020-03-04-sourdough-pancakes %}). They are fluffy and wonderful cooked in a cast-iron skillet with some good maple syrup, or with blueberries in them, or banana slices...
